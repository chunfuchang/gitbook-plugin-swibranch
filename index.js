...
module.exports = {
	...
	hooks: {
		...
		page: function(page) {
			...
			var dropdown = '<div id="zk-swibranch-btn" class="dropdown pull-left">' + '<a href="#" class="btn toggle-dropdown" aria-label="Toggle share dropdown"><i class="fa fa-file-text"></i> current: ' + current + '</a><div class="dropdown-menu font-settings dropdown-left">' + '<div class="dropdown-caret">' + '<span class="caret-outer"></span>' + '<span class="caret-inner"></span>' + '</div>' + '<div class="buttons">' + buttons + '</div>' + '</div>' + '</div>';
